...
<head>
	...
	<script src="<%= request.getContextPath() %>/web/js/custom/showInsertGeoFile.js" type="text/javascript"></script>
...
<!--<s:form name="f1"  validate="true" theme="simple" >-->
               ...
               <div class="span12">
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li> <a href="<%= request.getContextPath() %>/admin_showInsertGeoFile">  Insert Geo File </a><span class="divider-last">&nbsp;</span></li>
                   </ul>
               </div>
            </div>
            <!-- END PAGE HEADER-->
               ...
               <div class="span12">
                  ...
                  <div class="widget">
                     <div class="widget-title">
                        <h4><i class="icon-share-alt"></i>Insert&nbsp;Geo File</h4>
                        <span class="tools">
 ...
 <div id="insert_geo_form">
                  ...
                  <div class="widget"> 
                     <div class="widget-title">
                        <h4><i class="icon-share-alt"></i>Search&nbsp;/Add/Update IP</h4>
                        <span class="tools">
                           <a href="javascript:;" class="icon-chevron-down"></a>
                           <a href="javascript:;" class="icon-remove"></a>
                        </span>
     ...
     <div  class="form-inline" id="add_ip_address">
			...
			<div class="clear"></div>
                  ...
                  <div class="widget"> 
                     <div class="widget-title">
                        <h4><i class="icon-share-alt"></i>Country IP Range Logs</h4>
                        <span class="tools">
                           <a href="javascript:;" class="icon-chevron-down"></a>
                           <a href="javascript:;" class="icon-remove"></a>
                        </span>
...
<!-- End For Datatable (searching)--> 
   ...
   <script src="<%= request.getContextPath() %>/web/js/custom/showInsertGeoFile_editable.js" type="text/javascript"></script>
    <script>
