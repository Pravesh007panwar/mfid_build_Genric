...
<head>
	...
	<script src="<%= request.getContextPath() %>/web/js/custom/lockout_attempt_policy.js" type="text/javascript"></script>
				   ...
				   <div class="span12">
					  <h3 class="page-title">
					   ...
					   <ul class="breadcrumb">
						   ...
						   <li> <a href="<%= request.getContextPath() %>/policy_showLockOutAttemptPolicy">Lockout Attempt Policy</a><span class="divider-last">&nbsp;</span></li>
					   </ul>
				   </div>
				</div>
				<!-- END PAGE HEADER-->
													...
													<div id="policyFormdiv" style="display:none;">
														<form class="form-horizontal" action="#" id="policyAddForm">
															...
															--><div class="control-group">
																...
																<div class="controls">
																	<input type="text" id="numberOfAttempts" class="input-large checkDecimalValue" />
																</div>
															</div>
															<div class="control-group">
																<label class="control-label">Duration of Lock(in min.)</label>
																<div class="controls">
																	<input type="text" id="durationOfLock" class="input-large checkDecimalValue" />
																</div>
															</div>
															<!--<div class="control-group">
															...
															<input type="hidden" id="numberOfAttemptsBeforeEdit" />
															<input type="hidden" id="durationOfLockBeforeEdit" />
...
<!-- End For Datatable (searching)--> 
   ...
   <script src="<%= request.getContextPath() %>/web/js/in/lockout-attempt-policy-editable.js"></script>
  ...
  $(document).ajaxComplete(function(){
	...
	$(document).on('click','#addTo',function(){
		...
		$(document).on('change','.addtoType',function(){
			try{
			var val = $(this).val();
		...
		//$('#addTo_search_btn').live('click',function(){
...
// Below method allow only number without decimal value , created by Abhimanyu		
 $('.checkDecimalValue').keyup(function(){
		    var val = $(this).val();
