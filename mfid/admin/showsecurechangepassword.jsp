...
<head>
	...
	<script src="<%= request.getContextPath() %>/web/js/custom/changesecurepassword.js" type="text/javascript"></script>
               ...
               <div class="span12">
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li> <a href="<%= request.getContextPath() %>/admin_showSecureChangePassword">Change Password</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
               </div>
            </div>
            <!-- END PAGE HEADER-->
