...
<script src="<%= request.getContextPath() %>/web/js/custom/resync_Clock.js" type="text/javascript"></script>
		<script src="<%= request.getContextPath() %>/web/js/custom/showtransaction.js" type="text/javascript"></script>
               ...
               <div class="span12">
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li> <a href="<%= request.getContextPath() %>/admin_showTransaction.action?a=transaction">Transaction Mapping</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
               </div>
            </div>
            <!-- END PAGE HEADER-->
               ...
               <div class="span12">
                  ...
                  <div class="widget">
                     <div class="widget-title">
                        <h4><i class="icon-share-alt"></i>Transaction Mapping</h4>
                        <span class="tools">
                     ...
                     <div id="transactiondata" class="widget-body form">
						...
						<label>Application </label>
						  <s:select   id="sapAppId" name="switchAppName" headerKey="select" headerValue="Select Application"    list="#session.applicationList"/>
						</div>
