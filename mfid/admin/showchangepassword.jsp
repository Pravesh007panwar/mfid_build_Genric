...
<head>
	...
	<script src="<%= request.getContextPath() %>/web/js/custom/changepassword.js" type="text/javascript"></script>
               ...
               <div class="span12">
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li> <a href="<%= request.getContextPath() %>/admin_showChangePassword">Change Password</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
               </div>
            </div>
            <!-- END PAGE HEADER-->
               ...
               <div class="span12">
                  ...
                  <div class="widget">
                     <div class="widget-title">
                        <h4><i class="icon-share-alt"></i>Change&nbsp;Password</h4>
                        <span class="tools">
                     ...
                     <div class="widget-body form">
                        <!-- BEGIN FORM-->
                        <form action="javascript:;" id="cPasswordForm" class="form-horizontal">
                        	<div class="control-group">
                              <label class="control-label">Old Password <span class="help-inline red_color">*</span></label>
                              <div class="controls">
                           ...
                           <div class="control-group">
                              <label class="control-label">New Password <span class="help-inline red_color">*</span></label>
                              <div class="controls">
                           ...
                           <div class="control-group">
                              <label class="control-label">Confirm Password <span class="help-inline red_color">*</span></label>
                              <div class="controls">
...
<!-- End For Datatable (searching)--> 
   ...
   jQuery(document).ready(function() { 
         ...
         App.init();
		TableEditable.init();
		try{ $("#cPasswordForm")[0].reset();}catch(err) {} // add line for bug id #460 
