...
<head>
	...
	<script src="<%= request.getContextPath() %>/web/js/custom/token_activation_policy.js" type="text/javascript"></script>
				   ...
				   <div class="span12">
					  <h3 class="page-title">
					   ...
					   <ul class="breadcrumb">
						   ...
						   <li><a href="<%= request.getContextPath() %>/policy_showTokenActivationPolicy">Token Activation Policy</a><span class="divider-last">&nbsp;</span></li>
					   </ul>
				   </div>
				</div>
				<!-- END PAGE HEADER-->
...
<!-- End For Datatable (searching)--> 
  ...
  <%--  <script src="<%= request.getContextPath() %>/web/js/table-editable.js"></script> --%>
   ...
   <script src="<%= request.getContextPath() %>/web/js/in/token-activation-policy-editable.js"></script>
