...
<script
	src="<%= request.getContextPath() %>/web/js/custom/showResync.js"
...
<body class="fixed-top">
	...
	<div id="container" class="row-fluid">
		...
		<div id="main-content">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						<h3 class="page-title">Resync Server</h3>
						<ul class="breadcrumb">
							<li><a
							...
							<li><a
								href="<%= request.getContextPath() %>/admin_showResync">
									Resync Server</a><span class="divider-last">&nbsp;</span></li>
						</ul>
					</div>
				</div>
				<!-- END PAGE HEADER-->
					...
					<div class="span12">
						...
						<div class="widget">
							<div class="widget-title">
								<h4>
									<i class="icon-share-alt"></i>Resync&nbsp;Server
								</h4>
								...
								<div class="row-fluid">
									<div class="controls">
										<button class="btn btn-primary" type="button" data-target=""
											data-toggle="modal" id='resync_model1'>Resync Server</button>
									</div>
									<div class="clear"></div>
								</div>
							</div>
	...
	<script>
		...
		$('#resync_model1')
				.click(function() {
					if (confirm('Do you want to resync NTP Server? If you continue then it will affected for all users') == true) {
