...
<head>
	...
	<script src="<%= request.getContextPath() %>/web/js/custom/emergency_policy.js" type="text/javascript"></script>
				   ...
				   <div class="span12">
					  <h3 class="page-title">
					   ...
					   <ul class="breadcrumb">
						   ...
						   <li> <a href="<%= request.getContextPath() %>/policy_showEmergencyPolicy">Emergency Policy</a><span class="divider-last">&nbsp;</span></li>
					   </ul>
				   </div>
				</div>
				<!-- END PAGE HEADER-->
...
<!-- End For Datatable (searching)--> 
   ...
   <script src="<%= request.getContextPath() %>/web/js/in/emergency-policy-editable.js"></script>
  ...
  $(document).ajaxComplete(function(){
	...
	//$('#addTo').live('change',function(){
		$(document).on('change','#addTo',function(){
