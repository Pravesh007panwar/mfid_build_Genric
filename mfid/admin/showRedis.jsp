...
<script src="<%= request.getContextPath() %>/web/js/custom/showRedis.js"
...
<body class="fixed-top">
	...
	<div id="container" class="row-fluid">
		...
		<div id="main-content">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						<h3 class="page-title">Restart Redis Server</h3>
						<ul class="breadcrumb">
							<li><a
							...
							<li><a
								href="<%= request.getContextPath() %>/admin_showRedis">
									Redis Server</a><span class="divider-last">&nbsp;</span></li>
						</ul>
					</div>
				</div>
				<!-- END PAGE HEADER-->
								...
								<div class="row-fluid">
									<div class="controls">
										...
										<button class="btn btn-primary" type="button" data-target=""
											data-toggle="modal" id='resync_model1'>Restart Redis
											Server</button>
									</div>
									<div class="clear"></div>
								</div>
	...
	<script>
		...
		$('#resync_model1').click(function() {
			if (confirm('Do you want to restart Redis Server ?') == true) {
				$('#resync_model1').attr("data-target", "#myModal");
			} else {
