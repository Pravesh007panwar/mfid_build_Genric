				   ...
				   <div class="span12">
					  <h3 class="page-title">
					   ...
					   <ul class="breadcrumb">
						   ...
						   <li><a href="<%= request.getContextPath() %>/admin_showManageWhiteListed">Manage Device Whitelisting </a><span class="divider-last">&nbsp;</span></li>
					   </ul>
				   </div>
				</div>
				<!-- END PAGE HEADER-->
							...
							<div class="span12">
								<div class="widget widget-tabs">
									<div class="widget-title">
									   <h4><i class="icon-retweet"></i> Manage Device Whitelisting </h4>
									   <span class="tools">
										...
										<div class="tabbable table_tab_box tabbable-custom">
											<div class="row-fluid">
												<a class="icon-btn span2 active" id ="tab_1" href="#block_manage_radius" data-toggle="tab">
													...
													<div>Manage Whitelisting Device</div>
													</span>
												</a>
												...
												<a class="icon-btn span2 " id ="tab_2" href="#block_start_radius" data-toggle="tab">
													<span>
													<i class="icon-group"></i>
													<div>Import Whitelisting Devices</div>
													</span>
												</a>
											</div> 
											<div class="tab-content">
												<div class="tab-pane active" id="block_manage_radius">
													<div id="manage_whitelisting_devices_data"></div>
													
													
													<div class="row" id="manage_whitelisting_devices_form" style="display:none;" >
												...
												<!-- BEGIN SAMPLE FORM widget-->
														<div class="widget">
															<div class="widget-title">
																<h4>
																	<i class="icon-share-alt"></i>Import&nbsp;WhiteListed Device File
																</h4>
															...
															<div
																...
																<div class="row-fluid">
																	<div class="controls">
																		...
																		<div id="import_whitelist_device">
																		
																		<form action="admin_insertWhitelistedDeviceFile.action" onsubmit="return fileValidationEvent()" method="post" enctype="multipart/form-data">
																			<input type="file" name="whiteListDeviceFile" id="whiteListFile" />
																			&nbsp;
																		    <a href="manuals/sample-whiteListed-device-import-file.csv" id="download-sample-import-file" download="sample-whiteListed-device-import-file.csv" class="tb_active"><img src="web/img/icon-help.png" height="20" width="20" style="float: center; margin-left:-80px; margin-top: px;" title="sample whiteListed device import file" alt=""></a>
 																			&nbsp; &nbsp;
																			<input type="hidden" name="csrfPreventionSalt" id="csrfPreventionSaltId" value="<%=request.getAttribute("csrfPreventionSalt") %>"/>
																			<button class='btn btn-primary' type='submit' id='whiteList_device_file'>Submit</button>
																				</form>
																		</div>
																	</div>
...
<!-- End For Datatable (searching)--> 
   ...
   <script src="<%= request.getContextPath() %>/web/js/custom/manageDeviceWhitelisting.js" type="text/javascript"></script>
...
if('<%= request.getAttribute("insertStatus") %>'!="" && '<%= request.getAttribute("insertStatus") %>'!="null"){
	alert('<%= request.getAttribute("insertStatus") %>');
	$('#block_start_radius').show();
}
});
