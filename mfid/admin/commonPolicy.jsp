...
<head>
	...
	<script src="<%= request.getContextPath() %>/web/js/custom/common_policy.js" type="text/javascript"></script>
				   ...
				   <div class="span12">
					  <h3 class="page-title">
					   ...
					   <ul class="breadcrumb">
						   ...
						   <li><a href="<%= request.getContextPath() %>/policy_showCommonPolicy">Common Policy</a><span class="divider-last">&nbsp;</span></li>
					   </ul>
				   </div>
				</div>
				<!-- END PAGE HEADER-->
												...
												<div class="tab-pane active " id="block_policy">
													...
													<div id="policyFormdiv" style="display:none;">
														<form class="form-horizontal" action="#" id="policyAddForm">
															...
															<div class="control-group">
																<label class="control-label">Expiration Time(in min.)</label>
																<div class="controls">
																	<input type="text" id="expirationTime" class="input-large" />
																</div>
															</div>
															<div class="control-group">
																...
																<div class="controls ">
																	<select class="input-large m-wrap"  name="policyType" id="policyType">
																		<option value="0">All</option><option value="1">HardPolicy</option><option value="2">SMSPolicy</option><option value="3">MobilePolicy</option><option value="6">BioPolicy</option><option value="7">PushPolicy</option>
																	</select>
																</div>
															</div>
															...
															<input type="hidden" id="reuseFlagBeforeEdit" />
															<input type="hidden" id="policyTypeBeforeEdit" />
															<input type="hidden" id="expireTimeBeforeEdit" />
...
<!-- End For Datatable (searching)--> 
   ...
   <script src="<%= request.getContextPath() %>/web/js/in/policy-editable.js"></script>
  ...
  $(document).ajaxComplete(function(){
    ...
    $("#loading").css("display","none");
     ...
     // alert("complete");
		...
		$('#addTo_search_btn').on('click',function(){ // Saurabh
	...
	//$('#addTo').live('change',function(){
		$(document).on('change','#addTo',function(){ // Saurabh 
		...
		//$('.addtoType').live('change',function(){
			$(document).on('change','.addtoType',function(){ // Saurabh
			try{
			var val = $(this).val();
