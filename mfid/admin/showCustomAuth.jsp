...
<head>
	...
	<script src="<%= request.getContextPath() %>/web/js/custom/customAuthproperties.js" type="text/javascript"></script>
...
<input type="hidden" id="custom_auth_id">	
	<!-- BEGIN CONTAINER -->
				   ...
				   <div class="span12">
					  <h3 class="page-title">
					   ...
					   <ul class="breadcrumb">
						   ...
						   <li><a href="<%= request.getContextPath() %>/admin_showCustomAuthInfo.action?a=administration">Manage Custom Auth Properties</a><span class="divider-last">&nbsp;</span></li>
						   <button class="btn btn-primary pull-right marl10" id="update" onclick="addNewKey()"> <span id="updatePropertyjh" class="icon-large"></span> &nbsp;&nbsp; Add New </button>&nbsp;&nbsp;
					   </ul>
				   </div>
				</div>
				<!-- END PAGE HEADER-->
							...
							<div class="span12">
								<div class="widget widget-tabs">
									<div class="widget-title">
									   <h4><i class="icon-retweet"></i> Manage Custom Auth Properties</h4>
									     <span class="tools">
										...
										<div class="tab-content">
											<div class="span6 offset3">				
												<div style="border:1px solid #ddd; padding:20px;">
													<form action="#" id="custominfo_form" onsubmit="return blockFormSubmitRequest()" name="formData" class="form-horizontal" method="post">
													<div id="cust_info_data"></div>
													
													<button  class="btn btn-primary pull-right" onclick="return updateProperties()">Update </button>	
	...
	<!-- END FOOTER -->
		...
		<div id="dialog" title="Add custom auth info">
  <div class="control-group" style="margin: 0; overflow: hidden;">
		<label class="span7 dialog-label-style">
		<span class="fl-l">Enter Key</span>
		<span class="help-inline red_color fl-widt5">*</span>
					</label>
						<div class="span5 dialog-input-style">
									<input placeholder="Enter Key" id="customAuthKeyId" type="text"  />
						</div>
						</div>
						
          <div class="control-group" style="overflow: hidden;">
		<label class="span7 dialog-label-style">
		<span class="fl-l">Enter Value</span>
		<span class="help-inline red_color fl-widt5">*</span>
					</label>
						<div class="span5 dialog-input-style">
									<input  id="customAuthValueId" type="text" placeholder="Enter Value" />
						<button  class="btn btn-primary btn-enrypt" onclick="saveKeyValue()">Add </button>
						<button  class="btn btn-primary btn-enrypt-cncl"  onclick="closePopUp()">Cancel </button>
						</div>
						</div>	
