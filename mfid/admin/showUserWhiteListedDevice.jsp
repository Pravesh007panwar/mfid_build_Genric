               ...
               <div class="span12">
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li> <a href="<%= request.getContextPath() %>/admin_showUserWhiteListedDevice">Whitelisted Device</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
               </div>
            </div>
            <!-- END PAGE HEADER-->
               ...
               <div class="span12">
                  ...
                  <div class="widget">
                     <div class="widget-title">
                        <h4><i class="icon-share-alt"></i>Whitelisted&nbsp;Device</h4>
                        <span class="tools">
...
<!-- End For Datatable (searching)--> 
  ...
  <script src="<%= request.getContextPath() %>/web/js/custom/showUserWhiteListedDevice.js" type="text/javascript"></script>
