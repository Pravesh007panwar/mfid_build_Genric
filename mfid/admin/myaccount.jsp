...
<head>
	...
	<script src="<%= request.getContextPath() %>/web/js/custom/myaccount.js" type="text/javascript"></script>
				   ...
				   <div class="span12">
					  <h3 class="page-title">
					   ...
					   <ul class="breadcrumb">
						   ...
						   <li><a href="<%= request.getContextPath() %>/admin_showMyAccount?a=admin">My Account</a><span class="divider-last">&nbsp;</span></li>
					   </ul>
				   </div>
				</div>
				<!-- END PAGE HEADER-->
							...
							<div class="span12">
								<div class="widget widget-tabs">
									<div class="widget-title">
									   <h4><i class="icon-retweet"></i> My Account</h4>
									     <span class="tools">
                           <a href="javascript:;" class="icon-chevron-down"></a>
                          <!--  <a href="javascript:;" class="icon-remove"></a> --><!--  Change by Saurabh -->
                        </span>
									</div>
										...
										<div class="tab-content">
											<div class="span6 offset3">				
												<div style="border:1px solid #ddd; padding:20px;">
													<form action="#" id="redius_form" class="form-horizontal">
														<div class="control-group">
															<label class="span6">User LogonId 
																<span class="help-inline red_color">*</span>
															</label>
															<div class="span6">
																<input id="userLogonId" readonly="readonly" type="text" class="span12" />
															</div>
														</div>
														
														<div class="control-group">
															<label class="span6">First Name 
																<span class="help-inline red_color">*</span>
															</label>
															<div class="span6">
														...
														<div class="control-group">
															<label class="span6">Mobile Number
																<span class="help-inline red_color">*</span>
															</label>
															<div class="span6">
														...
														<a href="#"  class="btn btn-primary pull-right" onclick="updateMyAccountDetail()">Submit </a>
