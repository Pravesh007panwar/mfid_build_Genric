...
<script src="<%= request.getContextPath() %>/web/js/custom/resync_Clock.js" type="text/javascript"></script>
	...
	<script src="<%= request.getContextPath() %>/web/js/custom/country_violation_policy.js" type="text/javascript"></script>
...
.multiselect-item .radio input[type="radio"], 
...
<!--<s:form name="f1"  validate="true" theme="simple" >-->
               ...
               <div class="span12">
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li> <a href="<%= request.getContextPath() %>/policy_showCountryViolationPolicy.action?a=policy">Country Violation Policy</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
               </div>
            </div>
            <!-- END PAGE HEADER-->
               ...
               <div class="span12">
                  ...
                  <div class="widget">
                     <div class="widget-title">
                        <h4><i class="icon-share-alt"></i>Country&nbsp;Violation&nbsp;Policy</h4>
                        <span class="tools">
	...
	<div id="mBodyCountryPolicyId" class="modal-body"> 
													...
													<div id="policyFormdiv" style="display:block;">
														<form class="form-horizontal" action="#" id="policyAddForm">
															<div class="control-group" id="countryPolicyDiv2">
	...
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-hidden="true">X</button>
		<h3 id="myModalLabelMessage">Add IP Range</h3>
	</div>
	 ...
	 <div id="policyFormdivId1" style="display:block;">
 	 ...
 	 <div id="policyFormdivId2" style="display:none;">
 	 	...
 	 	<div id="mBodyAddIpRangeId" class="modal-body"> 
														<form class="form-horizontal" action="#" id="policyAddForm">
															<div class="control-group" id="countryPolicyDiv1">
																<label class="control-label">List of Allowed Country</label>
																<div class="controls">
