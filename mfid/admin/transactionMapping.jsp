...
<script src="<%= request.getContextPath() %>/web/js/custom/resync_Clock.js" type="text/javascript"></script>
		<script src="<%= request.getContextPath() %>/web/js/custom/showtransactionMapping.js" type="text/javascript"></script>
...
<!--<s:form name="f1"  validate="true" theme="simple" >-->
               ...
               <div class="span12">
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li> <a href="<%= request.getContextPath() %>/admin_showTransactionMapping.action?a=transaction">Add Transaction</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
               </div>
            </div>
            <!-- END PAGE HEADER-->
               ...
               <div class="span12">
                  ...
                  <div class="widget">
                     <div class="widget-title">
                        <h4><i class="icon-share-alt"></i>Add Transaction</h4>
                        <span class="tools">
                           <a href="javascript:;" class="icon-chevron-down"></a>
                           <a href="javascript:;" class="icon-remove"></a>
                        </span>
                     </div>
                     <div id="transactiondata" class="widget-body form">
                        <!-- BEGIN FORM-->
                        <div class="row-fluid">
						<div class="span3 offset0" id="switch_app">
						<label>Application </label>
						  <s:select   id="sapAppId" onChange="fetchTransactionDetails()" name="switchAppName" headerKey="select" headerValue="Select Application"    list="#session.applicationList"/>
						</div>
						
						 <div id="showNewAppAdd" ></div>
					  
						<div id="showAppType"></div>
					    <div class="clear"></div>
						</div>
            <br/>
            <br/>  
              <div id="user_sap_transaction"></div>
	...
	<div class="modal-header">
		...
		<h3 id="myModalLabel">Add New Transaction</h3>
	</div>
	<div id="mBody" class="modal-body">
	Transaction
	   <input type="text" id="transactionData" value="" required/>
	</div>
	<div class="modal-footer">
	     <button class="btn btn-primary" onclick="addAppTransaction()">Save</button>
