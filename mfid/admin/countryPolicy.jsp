...
<head>
	...
	<script src="<%= request.getContextPath() %>/web/js/custom/country_policy.js" type="text/javascript"></script>
			...
			<div class="container-fluid">
				   ...
				   <div class="span12">
					  <h3 class="page-title">
					   ...
					   <ul class="breadcrumb">
						   ...
						   <li> <a href="<%= request.getContextPath() %>/policy_showCountryPolicy">Country Policy</a><span class="divider-last">&nbsp;</span></li>
					   </ul>
				   </div>
				</div>
				<!-- END PAGE HEADER-->
				...
				<div id="page" class="dashboard">                  
					...
					<div class="square-state">
						<div class="row-fluid ">
							<div class="span12">
								<div class="widget widget-tabs scroll-div">
														...
														<form class="form-horizontal" action="#" id="policyAddForm">
															...
															<label class="checkbox" style="display:inline-block; margin-left:20px;">
															 ...
															 <label class="checkbox" style="display:inline-block; margin-left:40px;">
																<span>
																	<input class="shadow_radio" name ="cp_radio"   type="radio" value="deny"/>
																</span>
															 Deny
															</label>
...
<!-- End For Datatable (searching)--> 
   ...
   <script src="<%= request.getContextPath() %>/web/js/in/country-policy-editable.js"></script>
