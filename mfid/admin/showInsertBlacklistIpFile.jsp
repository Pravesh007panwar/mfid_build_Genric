...
<head>
	...
	<script src="<%= request.getContextPath() %>/web/js/custom/showInsertBlacklistIpFile.js" type="text/javascript"></script>
               ...
               <div class="span12">
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li> <a href="<%= request.getContextPath() %>/admin_showInsertBlacklistIpFile">  Insert Blacklist IP CSV File </a><span class="divider-last">&nbsp;</span></li>
                   </ul>
               </div>
            </div>
            <!-- END PAGE HEADER-->
               ...
               <div class="span12">
                  ...
                  <div class="widget">
                     <div class="widget-title">
                        <h4><i class="icon-share-alt"></i>Insert Blacklist IP CSV File</h4>
                        <span class="tools">
                     ...
                     <div style="padding:10px; background:#f4f4f4; border:solid 1px #ddd; display:block; margin:10px 10px;">
													<div class="row-fluid">
														<div class="controls">
														
 <div id="insert_geo_form">
															<input type="file" name="geoFile" id="geoFile"/>&nbsp;&nbsp;

<a href="manuals/sample-import-black-list-ip.csv" id="download-sample-import-file" download="sample-import-black-list-ip.csv"><img src="web/img/icon-help.png" height="20" width="20" style="float: center; margin-left:-80px; margin-top: px;" title="sample import file" alt=""></a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;															<button class="btn btn-primary" type="button" data-target="" data-toggle="modal" id='insert_geo_file'>Submit</button>
		</div>													</div>
                  ...
                  <div class="widget"> 
                     <div class="widget-title">
                        <h4><i class="icon-share-alt"></i>Search&nbsp;/Add/Update Blacklist IP</h4>
                        <span class="tools">
                           <a href="javascript:;" class="icon-chevron-down"></a>
                           <a href="javascript:;" class="icon-remove"></a>
                        </span>
     ...
     <div  class="form-inline" id="add_ip_address">
															 
			<label class="control-label">Enter IP   &nbsp;</label>
				<input type="text" id="ipRangeId" class="input-large"/> <span style="color:#868686; font-size:18px; line-height:22px;"></span>  &nbsp; &nbsp;
             	&nbsp;&nbsp; &nbsp;&nbsp;<button class="btn btn-primary" type="button" data-target="" onclick="searchIpRangesWithValidation(false,false)" data-toggle="modal" id='insert_geo_file'>Search</button>
		</div>
	</div>
			...
			<div class="clear"></div>
                     ...
                     <div class="widget-body form" id="user_search_data_country_ipdata">
                        <!-- BEGIN FORM-->
                  ...
                  <div class="widget"> 
                     <div class="widget-title">
                        <h4><i class="icon-share-alt"></i>Blacklist IP Range Logs</h4>
                        <span class="tools">
                           <a href="javascript:;" class="icon-chevron-down"></a>
                           <a href="javascript:;" class="icon-remove"></a>
                        </span>
               ...
               <!--      <div style="padding:10px; background:#f4f4f4; border:solid 1px #ddd; display:block; margin:10px 10px;">
                                  ...
                                  <div  class="form-inline" id="add_ip_address">
																	...
																	<select class="input-large" id="country">
															...
															&nbsp;&nbsp; &nbsp;&nbsp;<button class="btn btn-primary" type="button" data-target="" onclick="addIpAddress()" data-toggle="modal" id='insert_geo_file'>Add</button>
		</div>		 											</div>
                     ...
                     <div class="widget-body form" id="user_resync_data_ipdata">
                        <!-- BEGIN FORM-->
         ...
         <input type="hidden" id="countryListId" />                           
...
<!-- End For Datatable (searching)--> 
   ...
   <script src="<%= request.getContextPath() %>/web/js/custom/showInsertBlacklistIpFile_editable.js" type="text/javascript"></script>
    <script>
...
$('#insert_geo_file').click(function(){
  insertGeoFile();
});
