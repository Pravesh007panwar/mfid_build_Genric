...
<head>
	...
	<script src="<%= request.getContextPath() %>/web/js/custom/hard_offline_policy.js" type="text/javascript"></script>
				   ...
				   <div class="span12">
					  <h3 class="page-title">
					   ...
					   <ul class="breadcrumb">
						   ...
						   <li> <a href="<%= request.getContextPath() %>/policy_showHardOfflinePolicy">Hard Offline Policy</a><span class="divider-last">&nbsp;</span></li>
					   </ul>
				   </div>
				</div>
				<!-- END PAGE HEADER-->
...
<!-- End For Datatable (searching)--> 
  ...
  <%--  <script src="<%= request.getContextPath() %>/web/js/table-editable.js"></script> --%>
   ...
   <script src="<%= request.getContextPath() %>/web/js/in/hard-offline-policy-editable.js"></script>
