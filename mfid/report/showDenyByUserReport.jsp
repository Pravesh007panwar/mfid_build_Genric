...
<head>
	...
	<script src="<%= request.getContextPath() %>/web/js/custom/deny_by_user_report.js" type="text/javascript"></script>
...
<!--<s:form name="f1"  validate="true" theme="simple" >-->
               ...
               <div class="span12">
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li> <a href="<%= request.getContextPath() %>/report_showDenyByUserReport">Deny By User Report</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
               </div>
            </div>
            <!-- END PAGE HEADER-->
               ...
               <div class="span12">
                  ...
                  <div class="widget">
                     <div class="widget-title">
                        <h4><i class="icon-share-alt"></i>Deny&nbsp;By&nbsp;User&nbsp;Report</h4>
                        <span class="tools">
	...
	<div id="mBody" class="modal-body"> 
	 ...
	 <tr><td><input type="checkbox" class="group-checkable" data-set="#sample_editable_2 .checkboxes" checked/> <b>Select All</b> </td></tr>
	  <tr><td> <input type="checkbox" name="usersummaryreportcolumn" class="checkboxes" value="User LogonId" checked/>  	User LogonId </td></tr>
	 <tr><td> <input type="checkbox" name="usersummaryreportcolumn" class="checkboxes" value="Country Name" checked/>  	Country Name </td></tr>
	 	   <tr><td><input type="checkbox" name="usersummaryreportcolumn" class="checkboxes"  value="Failure Count" checked/>  	Failure Count  </td></tr>
	   <tr><td><input type="checkbox" name="usersummaryreportcolumn" class="checkboxes"  value="Date" checked/>  Date  </td></tr>
...
function resetAllCheckboxAssociate(){
  ...
  $(document).on('click','.failure_attempt',function(){  
	...
	try{
	 if(data.indexOf(',') !== -1)
	 {
       showDenyByCountryExpendReport(data,false,false);
	 }
	}catch(err){}
