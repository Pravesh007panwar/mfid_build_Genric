...
<!--<s:form name="f1"  validate="true" theme="simple" >-->
               ...
               <div class="span12">
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li> <a href="<%= request.getContextPath() %>/report_showUserSummaryReport">User Summary Report</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
               </div>
            </div>
            <!-- END PAGE HEADER-->
               ...
               <div class="span12">
                  ...
                  <div class="widget">
                     <div class="widget-title">
                        <h4><i class="icon-share-alt"></i>User&nbsp;Summary&nbsp;Report</h4>
                        <span class="tools">
                       ...
                       <div  class="widget-body form">
												...
												<div id="user_summary_report_data_select_date"></div>
												<div id="user_summary_report_data"></div>
												<div class="expo_option">
													<div class="row-fluid" id="expo_opt">
													</div>
												</div>
										            <div class="row" style="height:20px;"></div>
													<div id="block_user_summary_data"></div>
	...
	<div id="mBody" class="modal-body"> 
	 ...
	 <tr><td><input type="checkbox" class="group-checkable"  id="selectAllId" data-set="#sample_editable_1 .checkboxes" checked /> <b>Select All</b> </td></tr>
	 <tr><td> <input type="checkbox" name="usersummaryreportcolumn" class="checkboxes" value="User Name" checked/>  User Name </td></tr>
	   <tr><td><input type="checkbox" name="usersummaryreportcolumn" class="checkboxes"  value="Creation Date" checked/>  Creation Date  </td></tr>
	<tr><td>  <input type='checkbox' name="usersummaryreportcolumn" class='checkboxes'  value='Application' checked/>  Application  </td></tr>
	<tr><td>  <input type='checkbox' name="usersummaryreportcolumn" class='checkboxes'  value='Token Type' checked/>  Token Type  </td></tr>
	
  <tr><td> <input type='checkbox' name="usersummaryreportcolumn" class='checkboxes'  value='Last Login'  checked/>  Last Login </td></tr>
	 <tr><td> <input type='checkbox' name="usersummaryreportcolumn" class='checkboxes'  value='Success Attempts' checked/>  Success Attempts  </td></tr>
	  <tr><td> <input type='checkbox' name="usersummaryreportcolumn" class='checkboxes' value='Failure Attempts' checked />  Failure Attempts </td></tr>
	 <tr><td> <input type='checkbox' name="usersummaryreportcolumn" class='checkboxes'  value='Emergency Attempts' checked/>  Emergency Attempts </td></tr>
	 </table>
 
	   
 </div>
	<div class="modal-footer">
	     <button class="btn btn-primary" onclick="exportUserSummaryReport()">Export</button>
	...
	<div id="mBody" class="modal-body"> 
	 ...
	 <tr><td><input type="checkbox" class="group-checkable1"  id="selectAllIdAss" data-set="#sample_editable_2 .checkboxes" checked /> <b>Select All</b> </td></tr>
	 <tr><td> <input type="checkbox" name="usersummaryreportcolumn_Ass" class="checkboxes" value="User Name" checked/>  User Name </td></tr>
	   <tr><td><input type="checkbox" name="usersummaryreportcolumn_Ass" class="checkboxes"  value="Application" checked/>  Application  </td></tr>
	<tr><td>  <input type='checkbox' name="usersummaryreportcolumn_Ass" class='checkboxes'  value='Transaction Time' checked/>Transaction Time</td></tr>
	<tr><td>  <input type='checkbox' name="usersummaryreportcolumn_Ass" class='checkboxes'  value='status' checked/>status  </td></tr>
  </table>
 
	   
 </div>
	<div class="modal-footer">
	     <button class="btn btn-primary" onclick="exportUserSummaryReport_Ass()">Export</button>
		<button class="btn" data-dismiss="modal" aria-hidden="true">Close</button>
...
<!-- End For Datatable (searching)--> 
   ...
   <script src="<%= request.getContextPath() %>/web/js/custom/user_summary_report.js" type="text/javascript"></script>
...
//jQuery('.group-checkable').live('change',function(){
	...
	$(document).on('click', '.group-checkable1', function() {
		//alert("group checkable1");
...
function resetAllCheckboxAssociate(){
