...
<script src="<%= request.getContextPath() %>/web/js/custom/resync_Clock.js" type="text/javascript"></script>
	<script src="<%= request.getContextPath() %>/web/js/custom/showAdminLogsReport.js" type="text/javascript"></script>
...
<!--<s:form name="f1"  validate="true" theme="simple" >-->
               ...
               <div class="span12">
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li> <a href="<%= request.getContextPath() %>/report_showAdminLogsReport">Admin Log Report</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
               </div>
            </div>
            <!-- END PAGE HEADER-->
               ...
               <div class="span12">
                  ...
                  <div class="widget">
                     <div class="widget-title">
                        <h4><i class="icon-share-alt"></i>Admin&nbsp;Log&nbsp;Report&nbsp;</h4>
                        <span class="tools">
                     ...
                     <div id="mysql" class="widget-body form">
                        <!-- BEGIN FORM-->
           <div id="block_show_admin_log_report_data"></div>
	...
	<div id="mBody" class="modal-body"> 
	 ...
	 <tr><td> <input type="checkbox" name="usersummaryreportcolumn" class="checkboxes" value="Admin LogonId" checked/>  Admin LogonId </td></tr>
	...
	<tr><td>  <input type='checkbox' name="usersummaryreportcolumn" class='checkboxes'  value='Activity Time' checked/>  Activity Time  </td></tr>
	<tr><td>  <input type='checkbox' name="usersummaryreportcolumn" class='checkboxes'  value='Activity' checked/>  Activity  </td></tr>
	 <tr><td>  <input type='checkbox' name="usersummaryreportcolumn" class='checkboxes'  value='Activity Type' checked/>  		Activity Type  </td></tr>
  <tr><td> <input type='checkbox' name="usersummaryreportcolumn" class='checkboxes'  value='Role'  checked/> 	Role </td></tr>
  </table>
