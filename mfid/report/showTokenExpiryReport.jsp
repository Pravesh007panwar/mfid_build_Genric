...
<script
	src="<%= request.getContextPath() %>/web/js/custom/token_expiry_report.js"
...
<link href="<%= request.getContextPath() %>/web/css/style.css"
	rel="stylesheet" />
<link href="<%= request.getContextPath() %>/web/css/flags32.css"
	rel="stylesheet" />
<link
...
.pad {
	...
	padding: 0px;
	overflow: hidden;
	border: #ddd /**rgb(47, 126, 216)**/ 1px solid;
	border-radius: 5px;
}
...
<body class="fixed-top">
	...
	<div id="container" class="row-fluid">
		...
		<div id="main-content">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						<h3 class="page-title">Token Expiry Report</h3>
						<ul class="breadcrumb">
							<li><a
							...
							<li><a
								href="<%= request.getContextPath() %>/report_showTokenExpiryReport">Token
									Expiry Report</a><span class="divider-last">&nbsp;</span></li>
						</ul>
					</div>
				</div>
				<!-- END PAGE HEADER-->
					...
					<div class="span12">
						...
						<div class="widget">
							<div class="widget-title">
								<h4>
									<i class="icon-share-alt"></i>Token&nbsp;Expiry&nbsp;Report
								</h4>
							...
							<div class="widget-body form">
								...
								<div id="block_token_expiry_report_container"></div>
			...
			<div id="myModal1" class="modal hide fade" tabindex="-1"
				...
				<div id="mBody" class="modal-body">
					<table id="sample_editable_2">
						...
						<tr>
							<td><input type="checkbox" name="tokenExpirtyReportColumn"
								class="checkboxes" value="UserLogonId" checked /> UserLogonId</td>
						</tr>
						<tr>
							<td><input type="checkbox" name="tokenExpirtyReportColumn"
								class="checkboxes" value="App Name" checked /> App Name</td>
						</tr>
						<tr>
							<td><input type="checkbox" name="tokenExpirtyReportColumn"
								class="checkboxes" value="Left Days" checked /> Left Days</td>
						</tr>
						<tr>
							<td><input type="checkbox" name="tokenExpirtyReportColumn"
								class="checkboxes" value="ExpiredOn" checked /> ExpiredOn</td>
						</tr>

					</table>
				</div>
				<div class="modal-footer">
					<button class="btn btn-primary" onclick="exportTokenExpiryReport()">Export</button>
		...
		<%-- <script
			src="<%= request.getContextPath() %>/web/js/jquery-1.7.1.min.js"></script> --%>
	...
	<%-- 	<script src="<%= request.getContextPath() %>/web/js/data.js"></script> --%>
		...
		<%
			String domainName=SessionUtil.getDomain().getDomainName();
		%>
<script>
