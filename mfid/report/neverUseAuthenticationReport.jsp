...
<head>
	...
	<script src="<%= request.getContextPath() %>/web/js/custom/neverUseAuthenticationReport.js" type="text/javascript"></script>
...
<!--<s:form name="f1"  validate="true" theme="simple" >-->
	...
	<div id="container" class="row-fluid">
		...
		<div id="main-content">
         ...
         <div class="container-fluid">
               ...
               <div class="span12">
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li> <a href="<%= request.getContextPath() %>/report_showNeverUserAuthenticationReport">No Authentication Attempt </a><span class="divider-last">&nbsp;</span></li>
                   </ul>
               </div>
            </div>
            <!-- END PAGE HEADER-->
               ...
               <div class="span12">
                  ...
                  <div class="widget">
                     <div class="widget-title">
                        <h4><i class="icon-share-alt"></i>&nbsp;No&nbsp;Authentication&nbsp;Attempt</h4>
                        <span class="tools">
			...
			<div id="block_never_use_athentication_data"></div>
	...
	<div id="mBody" class="modal-body"> 
	 ...
	 <tr><td> <input type="checkbox" name="usersummaryreportcolumn" class="checkboxes" value="User Name" checked/>  User LogonId </td></tr>
	   <tr><td><input type="checkbox" name="usersummaryreportcolumn" class="checkboxes"  value="Application" checked/>  Application  </td></tr>
	<tr><td>  <input type='checkbox' name="usersummaryreportcolumn" class='checkboxes'  value='Domain' checked/>  Domain  </td></tr>
	<tr><td>  <input type='checkbox' name="usersummaryreportcolumn" class='checkboxes'  value='Token Type' checked/>  Token Type  </td></tr>
 <!-- 21-Sep-2017	 <tr><td>  <input type='checkbox' name="usersummaryreportcolumn" class='checkboxes'  value='Token Serial/License Type' checked/>  	Token Serial / License Key  </td></tr> -->
  <!-- 04-Nov-2016 <tr><td> <input type='checkbox' name="usersummaryreportcolumn" class='checkboxes'  value='Active Date'  checked/> Active Date </td></tr> -->
  </table>
 
	   
 </div>
	<div class="modal-footer">
	     <button class="btn btn-primary" onclick="exportNeverUseAuthenticationReport()">Export</button>
   ...
   jQuery(document).ready(function() { 
       ...
       jQuery(document).ready(function() { 
    	...
    	org='<%=orgName%>';
		 ...
		 openNeveruseAthentication(org,false,false);
