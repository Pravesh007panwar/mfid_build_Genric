...
<script src="<%= request.getContextPath() %>/web/js/custom/resync_Clock.js" type="text/javascript"></script>
	<script src="<%= request.getContextPath() %>/web/js/custom/allDomainTokenReport.js" type="text/javascript"></script>
...
<!--<s:form name="f1"  validate="true" theme="simple" >-->
               ...
               <div class="span12">
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li> <a href="<%= request.getContextPath() %>/report_showAllDomainTokenDetailReport">Token Details</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
               </div>
            </div>
            <!-- END PAGE HEADER-->
               ...
               <div class="span12">
                  ...
                  <div class="widget">
                     <div class="widget-title">
                        <h4><i class="icon-share-alt"></i>Token&nbsp;Details</h4>
                        <span class="tools">
                     ...
                     <div id="mysql" class="widget-body form">
                        <!-- BEGIN FORM-->
           <div id="block_token_detail_data"></div>
													<div id="user_detail_athentication_data"></div>
	...
	<div id="mBody" class="modal-body"> 
	 ...
	 <tr><td> <input type="checkbox" name="usersummaryreportcolumn" class="checkboxes" value="License Key" checked/>  	License Key </td></tr>
	...
	<tr><td>  <input type='checkbox' name="usersummaryreportcolumn" class='checkboxes'  value='Application' checked/>  Application  </td></tr>
	 <tr><td>  <input type='checkbox' name="usersummaryreportcolumn" class='checkboxes'  value='Token Status' checked/>  	Token Status </td></tr>
   </table>
 
	   
 </div>
	<div class="modal-footer">
	     <button class="btn btn-primary" onclick="exportAllDomainToken()">Export</button>
  ...
  $(document).ajaxComplete(function(){
    ...
    $("#loading").css("display","none");
     ...
     // alert("complete");
      ...
      $(document).on('click','.total_td',function(){  
      var val=$(this).attr('data');
	  try{ $("#pageId_assign").val(''); $("#pageNum_assign").val(''); }catch(err){}
	athenticationDetail_tab(val,false,false,false);
