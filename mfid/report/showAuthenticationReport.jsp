...
<!--<s:form name="f1"  validate="true" theme="simple" >-->
               ...
               <div class="span12">
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li> <a href="<%= request.getContextPath() %>/report_showAuthenticationReport">Authentication Report</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
               </div>
            </div>
            <!-- END PAGE HEADER-->
               ...
               <div class="span12">
                  ...
                  <div class="widget">
                     <div class="widget-title">
                        <h4><i class="icon-share-alt"></i>Authentication&nbsp;Report</h4>
                        <span class="tools">
	...
	<div id="mBody" class="modal-body"> 
	 ...
	 <tr><td> <input type="checkbox" name="usersummaryreportcolumn" class="checkboxes" value="User Name" checked/>  User Name </td></tr>
	   <tr><td><input type="checkbox" name="usersummaryreportcolumn" class="checkboxes"  value="Authentication Type" checked/>  Authentication Type </td></tr>
	<tr><td>  <input type='checkbox' name="usersummaryreportcolumn" class='checkboxes'  value='Token Serial/License key' checked/> Token Serial/License key  </td></tr>
  </table>
 
	   
 </div>
	<div class="modal-footer">
	     <button class="btn btn-primary" onclick="exportAuthenticationReport()">Export</button>
...
<!-- End For Datatable (searching)--> 
   ...
   <script src="<%= request.getContextPath() %>/web/js/custom/authenticationreport.js" type="text/javascript"></script>
