               ...
               <div class="span12">
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li> <a href="<%= request.getContextPath() %>/report_showLockedUnlockedUsersRreport"> Locked Unlocked User Report</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
               </div>
            </div>
            <!-- END PAGE HEADER-->
               ...
               <div class="span12">
                  ...
                  <div class="widget">
                     <div class="widget-title">
                        <h4><i class="icon-share-alt"></i>Locked&nbsp;Unlocked&nbsp;User&nbsp;Report</h4>
                        <span class="tools">
                       	...
                       	<div  class="widget-body form">
                     			...
                     			<div id="container_domain"></div><div style="clear:both;"></div>
                                	<div id="locked_unlocked_user_chart"></div>
                                	<div id="locked_unlocked_user_data"></div>
...
<!-- End For Datatable (searching)--> 
   ...
   <script src="<%= request.getContextPath() %>/web/js/custom/lockedUnlockedUserReport.js" type="text/javascript"></script>
