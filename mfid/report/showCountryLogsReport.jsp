...
<body class="fixed-top">
	...
	<div id="container" class="row-fluid">
		...
		<div id="main-content">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						<h3 class="page-title">Country Policy Log Report</h3>
						<ul class="breadcrumb">
							<li><a
							...
							<li><a
								href="<%= request.getContextPath() %>/report_showCountryLogsReport">Country Policy
					...
					<div class="span12">
						...
						<div class="widget">
							<div class="widget-title">
								<h4>
									<i class="icon-share-alt"></i>Country&nbsp;Policy&nbsp;Log&nbsp;Report&nbsp;
								</h4>
						...
						<div id = "_country_second_widget" class="widget" style="display:none">
							<div class="widget-title">
								<h4>
									<i class="icon-share-alt"></i>Country&nbsp;List
								</h4>
								<span class="tools"> <a href="javascript:;"
									class="icon-chevron-down"></a> <a href="javascript:;"
									class="icon-remove"></a>
							...
							<div id="mysql" class="widget-body form">
								...
								<div id="_block_show_country_log_report_data"></div>
							</div>
							<!-- END SAMPLE FORM widget-->
						</div>
		...
		<div id="myModal1" class="modal hide fade" tabindex="-1" role="dialog"
			...
			<div id="mBody" class="modal-body">
				...
				<table id="sample_editable_2">
					...
					<tr>
						<td><input type="checkbox" name="country_policy_report_column"
							class="checkboxes" value="Admin LogonId" checked /> Admin LogonId
						</td>
					</tr>
					
					<tr>
						<td><input type="checkbox" name="country_policy_report_column"
							class="checkboxes" value="Application" checked /> Application</td>
					</tr>
					<tr>
						<td><input type='checkbox' name="country_policy_report_column"
							class='checkboxes' value='Activity Time' checked /> Activity Time
						</td>
					</tr>
					<tr>
						<td><input type='checkbox' name="country_policy_report_column"
							class='checkboxes' value='Allowed Country' checked /> Allowed Country
						</td>
					</tr>
					...
					<tr>
						<td><input type='checkbox' name="country_policy_report_column"
							class='checkboxes' value='Activity Type' checked /> Activity Type</td>
					</tr>
					
					<tr>
						<td><input type='checkbox' name="country_policy_report_column"
							class='checkboxes' value='Role' checked /> Role</td>
					</tr>
				</table>
			...
			<div class="modal-footer">
				<button class="btn btn-primary" onclick="exportCountryPolicyLogsReport()">Export</button>
   ...
   <![endif]-->
	...
	<script
		src="<%= request.getContextPath() %>/web/js/custom/showCountryLogsReport.js"
	...
	<script>
		jQuery(document).ready(function() {
			...
			App.init();
			TableEditable.init();
			//showCountryPolicyLogsReportFirstTime();
		...
		jQuery(document).on('click','.country_Click',function(){  
			$('#_country_second_widget').show();
			var data="";
			data=$(this).attr('data');
			$("html, body").animate({ scrollTop: $(document).height()-50}, "slow");
			slideDownOnCountryClick(data);
		});
