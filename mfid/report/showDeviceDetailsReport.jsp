...
<head>
	...
	<script src="<%= request.getContextPath() %>/web/js/custom/device_details_report.js" type="text/javascript"></script>
...
<!--<s:form name="f1"  validate="true" theme="simple" >-->
	...
	<div id="container" class="row-fluid">
               ...
               <div class="span12">
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li> <a href="<%= request.getContextPath() %>/report_showDenyByUserReport">Device Details Report</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
               </div>
            </div>
            <!-- END PAGE HEADER-->
               ...
               <div class="span12">
                  ...
                  <div class="widget">
                     <div class="widget-title">
                        <h4><i class="icon-share-alt"></i>Device&nbsp;Details&nbsp;&nbsp;Report</h4>
                        <span class="tools">
        ...
        Loading data ...
                  ...
                  <!-- END SAMPLE FORM widget-->
                      ...
                      <div  class="widget-body form">
                         <div id="deny_country_report_expend_container"></div>
                         <div id="block_deny_country_report_expend_container"></div>
                         <div id="failure_attempt_data"></div>
                                      <div class="expo_option">
			                          <div class="row-fluid" id="expo_opt">
			              </div> </div>  
			          </div>
	...
	<div id="mBody" class="modal-body"> 
	 ...
	 <tr><td><input type="checkbox" class="group-checkable" data-set="#sample_editable_2 .checkboxes" checked/> <b>Select All</b> </td></tr>
	  <tr><td> <input type="checkbox" name="usersummaryreportcolumn" class="checkboxes" value="Device Name" checked/>  	Device Name </td></tr>
	 <tr><td> <input type="checkbox" name="usersummaryreportcolumn" class="checkboxes" value="Device Type" checked/>  	Device Type </td></tr>
	 	   <tr><td><input type="checkbox" name="usersummaryreportcolumn" class="checkboxes"  value="Device OS version" checked/>  	Device OS version  </td></tr>
	   <tr><td><input type="checkbox" name="usersummaryreportcolumn" class="checkboxes"  value="Device App version" checked/>  Device App version  </td></tr>
	      <tr><td><input type="checkbox" name="usersummaryreportcolumn" class="checkboxes"  value="No of Associate User" checked/>  No of Associate User  </td></tr>
	...
	<tr><td>  <input type='checkbox' name="usersummaryreportcolumn_Ass" class='checkboxes'  value='IP Address' checked/>IP Address</td></tr>
...
function resetAllCheckboxAssociate(){
  ...
  $(document).on('click','.failure_attempt',function(){  
	var data='';
	try{
	document.getElementById('pageId_failure').value='';
	document.getElementById('pageNum_failure').value='';
	}catch(err){}
	...
	// if(data.indexOf(',') !== -1)
	 {
       showDeviceDetailsExpendReport(data,false,false);
	 }
	}catch(err){}
