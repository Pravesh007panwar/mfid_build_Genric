...
<script src="<%= request.getContextPath() %>/web/js/custom/resync_Clock.js" type="text/javascript"></script>
	<script src="<%= request.getContextPath() %>/web/js/custom/turnAroundTimeReport.js" type="text/javascript"></script>
               ...
               <div class="span12">
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li> <a href="<%= request.getContextPath() %>/report_showTurnAroundTimeReport">Turn Around Time Report</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
               </div>
            </div>
            <!-- END PAGE HEADER-->
               ...
               <div class="span12">
                  ...
                  <div class="widget">
                     <div class="widget-title">
                        <h4><i class="icon-share-alt"></i>Turn&nbsp;Around&nbsp;Time&nbsp;Report</h4>
                        <span class="tools">
                     ...
                     <div id="mysql" class="widget-body form">
                        <!-- BEGIN FORM-->
           <div id="block_turn_around_time_data"></div>
            <div id="block_turn_around_time_chart" ></div>
