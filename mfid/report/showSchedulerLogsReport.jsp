...
<body class="fixed-top">
	...
	<div id="container" class="row-fluid">
		...
		<div id="main-content">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						<h3 class="page-title">Scheduler Log Report</h3>
						<ul class="breadcrumb">
							<li><a
							...
							<li><a
								href="<%= request.getContextPath() %>/report_showSchedulerLogReport">Scheduler 
					...
					<div class="span12">
						...
						<div class="widget">
							<div class="widget-title">
								<h4>
									<i class="icon-share-alt"></i>Scheduler&nbsp;Log&nbsp;Report&nbsp;
								</h4>
   ...
   <![endif]-->
	...
	<script
		src="<%= request.getContextPath() %>/web/js/custom/showSchedulerLogReport.js"
	...
	<script>
		jQuery(document).ready(function() {
			...
			App.init();
			TableEditable.init();
			showSchedulerLogsReport(false,false);
