 ...
 function showDenyByCountryReport(pageCall,isSearch,domain)
	{
      ...
      // alert(to_date);
		   ...
		   var myUrl="report_showBioEnrollmentReportData.action?fromDate="+from_date+"&toDate="+to_date;
		   var dataString="";
		 // alert(myUrl); 
		if(pageCall==true){
			//alert("in true")
...
{	
    ...
    var domainName = ""; 
	 ...
	 $('#myModal1').modal('hide')	
	var reportType="pdf";
	var url="reportgen_getBioEnrollmentReport?reportType="+reportType+"&fileName=bio_enrollment_report.pdf&reportColumns="+globalArrayUserSummaryColumn+"&domain="+domainNameAdminLog+genAdminLogFilter;
...
{	 
	...
	if(globalShowPopupWindow)
	 ...
	 $('#myModal1').modal('hide')	
	var reportType="xml";
	var url="reportgen_getBioEnrollmentReport?reportType="+reportType+"&fileName=bio_enrollment_report.xml&reportColumns="+globalArrayUserSummaryColumn+"&domain="+domainNameAdminLog+genAdminLogFilter;
	$('#user_logon_id').val(getUserLogonId);
	$('#app_name').val(getAppNameId);
	$('#p_auth').val(getPauthId);
	$('#s_auth').val(getSauthId);
...
{	
	...
	var url="reportgen_getBioEnrollmentReport?reportType="+reportType+"&fileName=bio_enrollment_report.xlsx&reportColumns="+globalArrayUserSummaryColumn+"&domain="+domainNameAdminLog+genAdminLogFilter;
	$('#user_logon_id').val(getUserLogonId);
	$('#app_name').val(getAppNameId);
	$('#p_auth').val(getPauthId);
	$('#s_auth').val(getSauthId);
...
{	 globalReportType = "csv";
	...
	$('#myModal1').modal('hide')
	var reportType="csv";
	var url="reportgen_getBioEnrollmentReport?reportType="+reportType+"&fileName=bio_enrollment_report.csv&reportColumns="+globalArrayUserSummaryColumn+"&domain="+domainNameAdminLog+genAdminLogFilter;
	$('#user_logon_id').val(getUserLogonId);
	$('#app_name').val(getAppNameId);
	$('#p_auth').val(getPauthId);
	$('#s_auth').val(getSauthId);
