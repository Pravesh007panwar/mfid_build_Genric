...
try{
        ...
        jqTds[2].innerHTML = '<input type="text" id="ipRange1" class="m-wrap small" value="' + aData[2] + '">';
        jqTds[3].innerHTML = '<input type="text" id="ipRange2" class="m-wrap small" value="' + aData[3] + '">';
   ...
   alert(e);
	...
	else
	{
		cancelBtn = ' | <a class="cancel" data-mode="new" href="">Cancel</a>';
		  ...
		  jqTds[4].innerHTML = '<a class="edit" data="'+aData[1]+'" href="">Save</a>'+cancelBtn; 
