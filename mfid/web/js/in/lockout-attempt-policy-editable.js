    ...
    return {
        ...
        init: function () {
			...
			function editRow(oTable, nRow) {
                ...
                document.getElementById("numberOfAttemptsBeforeEdit").value=aData[1];
                document.getElementById("durationOfLockBeforeEdit").value=aData[1];
              
                document.getElementById("pId").value=aData[7];
                
               
                // add $trim for bug id #353,  added by abhimanyu 
                jqTds[0].innerHTML = '<input id="editPolicyDesc" type="text" class="m-wrap small"  value="'+$.trim(aData[0])+'">';
                jqTds[1].innerHTML = '<input id="editNumberOfAttempts"  type="number" class="m-wrap small" onkeyup="checkDecimalValue(1)"  value="'+$.trim(aData[1])+'" >';
                jqTds[2].innerHTML = '<input id="editDurationOfLock"  type="number" class="m-wrap small"  onkeyup="checkDecimalValue(2)" value="'+$.trim(aData[2])+'" >';
...
//Below method allow only number without decimal value , created by Abhimanyu		
	...
	function checkDecimalValue(checkId){
		
		if(checkId == 1)
		checkId = "#editNumberOfAttempts";
		else if(checkId == 2)
			checkId = "#editDurationOfLock";
