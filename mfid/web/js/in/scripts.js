var App = function () {
    ...
    var handleWidgetTools = function () {
        ...
        jQuery('.widget .tools .icon-chevron-down, .widget .tools .icon-chevron-up').click(function () {
            ...
            var databaseVendor=document.getElementById("vendor").value;
           
            if (jQuery(this).hasClass("icon-chevron-down")) {
                jQuery(this).removeClass("icon-chevron-down").addClass("icon-chevron-up");
                el.slideUp(200);
                if(databaseVendor=="Mysql"||databaseVendor=="Oracle"||databaseVendor=="SqlServer")
    				$('#ad').hide();
                else if(databaseVendor=="AD"||databaseVendor=="LDAP")
                	$('#mysql').hide();
            } else {
    ...
    var handleTables = function () {
        ...
        jQuery('#sample_5_wrapper .dataTables_filter input').addClass("input-small"); // modify table search input
        jQuery('#sample_5_wrapper .dataTables_length select').addClass("input-mini"); // modify table per page dropdown
		// begin: sixth table
        $('#sample_6').dataTable({
            "sDom": "<'row-fluid'<'span6'l><'span6'f>r>t<'row-fluid'<'span6'i><'span6'p>>",
            "sPaginationType": "bootstrap",
        ...
        jQuery('#sample_6_wrapper .dataTables_filter input').addClass("input-small"); // modify table search input
        jQuery('#sample_6_wrapper .dataTables_length select').addClass("input-mini"); // modify table per page dropdown
    }
