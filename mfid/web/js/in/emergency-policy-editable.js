    ...
    return {
        ...
        init: function () {
			...
			function editRow(oTable, nRow) {
                ...
                document.getElementById("numberOfHoursBeforeEdit").value=aData[1];
                ...
                jqTds[1].innerHTML = '<input id="editNumberOfHours"  type="text" class="m-wrap small"  value="'+$.trim(aData[1])+'" >';
